...
const footerHrefs: Record<string, string> = {
  ...
  "Biz haqimizda": "/#jamoa",
  Jamoa: "/#jamoa",
  "Bog'lanish": `mailto:${contactEmail}`,
};
...
export default async function Home() {
  ...
  try {
    ...
    console.warn("Landing DB xatosi, fallback ishlatildi:", err);
    ...
    <>
      <main id="content" style={{ minHeight: "100svh" }}>
          ...
          >
            {team.map((t) => (
              ...
              >
                ...
                >
                  {/* Surat bo'lsa — rasm, bo'lmasa ism bosh harflari */}
                  {t.photo ? (
                    <Image
                      src={t.photo}
                      /* Ism darhol quyidagi <h3> da turadi — alt'da takrorlansa
                       skrinrider uni ikki marta o'qiydi. Shu bois dekorativ. */
                      alt=""
                      width={152}
                      height={152}
                      sizes="76px"
                ...
                >
                  ...
                  {/* GitHub logosi Material Symbols'da yo'q — inline SVG */}
                  {t.github && (
                    <a
                      href={t.github}
                      target="_blank"
        ...
        <section
          id="narxlar"
          className="sec-x"
          style={{ maxWidth: 1180, margin: "64px auto 40px" }}
        >
          <div
            className="cta-box"
            style={{
