...
function SocialButtons() {
  return (
    <div className="grid grid-cols-2 gap-3 mb-6">
      <button className="flex items-center justify-center gap-2 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors text-sm font-medium text-slate-700 dark:text-slate-300">
    ...
    <PageTransition>
      <AuthLayout title="Xush kelibsiz!" subtitle="Hisobingizga kiring">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm"><span className="px-4 bg-slate-50 dark:bg-slate-950 text-slate-400">yoki</span></div>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none"
                placeholder="••••••••"
              />
    ...
    <PageTransition>
      <AuthLayout title="Ro'yxatdan o'ting" subtitle="Kelajak muhandisi bo'ling">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Ism</label>
            <div className="relative">
      ...
      <AuthLayout title="Parolni tiklash" subtitle="Email manzilingizni kiriting">
        {sent ? (
          <div className="text-center p-6 rounded-2xl bg-emerald-50 dark:bg-emerald-900/20">
            ...
            <p className="text-sm text-slate-500">Parolni tiklash havolasi {email} manziliga yuborildi.</p>
